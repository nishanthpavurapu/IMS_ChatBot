...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void buttonLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd_username = new SqlCommand("select amsid from Users where amsid='" + txtUsernameLogin.Text + "' and password='"+txtPasswordLogin.Text+"'",con);
            con.Open();
            ...
            else
            {
                ...
                SqlCommand cmd_phone = new SqlCommand("select amsid from Users where phone='" + txtUsernameLogin.Text + "' and password='" + txtPasswordLogin.Text + "'", con);
