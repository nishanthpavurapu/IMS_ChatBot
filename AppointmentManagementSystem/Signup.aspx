...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
        <label class="col-lg-12 control-toppad">Password</label>
        <div class="col-lg-8">
        ...
        <div class="row">
         <label class="col-lg-12 control-toppad">Confirm Password</label>
        <div class="col-lg-8">
        ...
        <div class="row">
         <label class="col-lg-12 control-toppad">Working Hours (00 : 24 hrs)</label>
        ...
        <div class="col-lg-12 space-vert center" style="padding-right:255px;">
            <asp:Button ID="buttonSignup" runat="server" Text="Sign Up" class="btn btn-success" OnClick="buttonSignup_Click"/>
        </div>
            </div>
            </div>
    </div>
